# FlinCGo (/flɪŋk-ɡoʊ/)
A lightweight observability platform for ESP32 devices with a collector and output interface on Linux PC. FlinCGo allows streaming real-time low-overhead logs and metrics over lossy networks with high throughput while efficiently implementing custom binary protocol, non-blocking batching, payload encryption, sequence loss tracking and comfortable user experience.
## Components
