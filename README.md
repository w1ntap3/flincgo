...
- **Automatic Flushing Deadline: Deadline (Longest deadline being once in ~49.7 days) counted after first initialization or after every flush before automatically flushing, even if the MTU limit was not hit.
